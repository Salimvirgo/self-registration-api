...
exports.createUSSDWrapper = (data) => {
...
exports.rejectUSSDWrapper = (data) => {
...
exports.TangoResponseUSSDWrapper = (data) => {

  //todo validate `data`
  return "<?xml version='1.0' encoding='UTF-8'?>\r\n" +
  "<!DOCTYPE pages SYSTEM 'cellflash.dtd'>\r\n" +
  "<pages descr='' >\r\n" +
  "<page  descr='Orange Money' hist='dohist' nav='end' ismenu='true' volatile='false'>\r\n" + 
  data +  
  "</page>\r\n" +
  "</pages>"
}