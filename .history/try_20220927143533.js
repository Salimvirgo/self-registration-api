 ...
 headers: {'Content-Type': 'text/xml'}
   ...
   axios
    ...
    .then((response) => {
      ...
      const content1 = "Please read and confirm Registration details: <br/>" + USSDresponse + "<br/>";
      
      const USSDwrapper = "<?xml version='1.0' encoding='UTF-8'?>\r\n" +
                        "<!DOCTYPE pages SYSTEM 'cellflash.dtd'>\r\n" +
                        "<pages descr='' >\r\n" +
                        "<page  descr='Orange Money' hist='dohist' nav='default' ismenu='true' volatile='false'>\r\n" + 
                        content1 + `<a href='/tangostream/'>Confirm </a><br/> 
...
var postRequest = {
      ...
      confirmwrapper = "<?xml version='1.0' encoding='UTF-8'?>\r\n" +
                        "<!DOCTYPE pages SYSTEM 'cellflash.dtd'>\r\n" +
                        "<pages descr='' >\r\n" +
                        "<page  descr='Orange Money' hist='dohist' nav='default' ismenu='true' volatile='false'>\r\n" + 
                        confirmcontent +  
