    ...
    if (response === "Confirm") {
      ...
      if (Object.keys(iPacsResponseData).length) {
        ...
        var postRequest = {
          ...
          const tangoURL = `172.25.160.27:50070/tango/mmoney/CelliciumSelector?REQUEST_GATEWAY_CODE=WEB&REQUEST_GATEWAY_TYPE=WEB&LOGIN=Web_Bearer2&PASSWORD=b3Jhbmdlb205MDg3Ym90&SOURCE_TYPE=BROWSER`;
         ...
         const tangoResponse = await axios.post(tangoURL,axiosHeaderOptions).catch((err) => {throw err})
