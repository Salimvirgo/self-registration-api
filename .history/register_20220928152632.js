  ...
  axios
    ...
    .then((response) => {
      ...
      const rename_keys = (keysMap, Regdata) =>
        ...
        //when the response be dae cam, e dae in different header name and the endpoint server nor dae recognize am so r be get for iterate and change d names
        //okay
      result = rename_keys(
        {
          id: "ID",
      ...
      //XML parser to parse the json response 
      const options = {
