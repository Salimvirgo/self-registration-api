...
app.get("/tango-stream?:response", async (req, res) => {
  try {
    ...
    if (response === "Reject") {
      ...
      const userRejectContent = '<form action="/tangostream3?:response" method="GET"><entry type="text" var="namevalue"><prompt>Please Enter your First and Middle Name </prompt></entry></form>';
